...
#                          process lifetime. Exact W1-A config/schema changes
#                          therefore require the same restart without widening
#                          this closure to unrelated engine modules.
