...
|---|---|---|
| **fable** (main loop + gated spawns) | planning, adjudication, rulings, merges, final synthesis; spawns ONLY via `orchestrator` + FABLE-WHY (see below) | fan-outs (×N), workflows, anything passing the draft-and-review test |
