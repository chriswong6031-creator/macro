...
Touches ONLY the gitignored cache parquets — never committed series (breadth.parquet
recomputes from the healed cache on the next collector run).

Usage:
  python scripts/heal_breadth_split_seams.py --data-dir /path/to/data \
      [--universes breadth smallcap_breadth midcap_breadth] [--dry-run]
"""
