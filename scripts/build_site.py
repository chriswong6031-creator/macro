...
def _sector_heat_view() -> dict | None:
    ...
    and up to 4 cooling/broken themes, each linking straight to basket/<id>.html (the
    template emits the detail-page href directly — the baskets.html#theme-<id> hop is
    retired and now only serves stale inbound links via the redirect stub's resolver).
