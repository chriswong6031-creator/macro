...
def all_adapters() -> dict:
    ...
    specs = [
        ...
        ("quiver", "collectors.quiver", "QuiverAdapter"),  # QuiverQuant alt-data (govcontracts/congress/lobbying/patents/offexchange/wsb) -> theme_activity fuser; no-op without QUIVER_API_KEY
