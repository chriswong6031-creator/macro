...
def all_adapters() -> dict:
    ...
    specs = [
        ...
        ("china_visits", "collectors.china_visits", "ChinaVisitsAdapter"),    # P1 institutional-visit tape, DERIVED from china_filings (category=='institutional_visit', RIGHTS-0 §1/§10) — no second CNInfo ingester; serial-loop timing means it reads the PRIOR night's china_filings store (one-cycle latency, not a defect) → data/china_visits/visits.parquet
