...
def all_adapters() -> dict:
    ...
    specs = [
        ...
        ("china_yield_spread", "collectors.china_yield_spread", "ChinaYieldSpreadAdapter"),  # CN vs US sovereign curve + slope + CN-US spread (carry/RMB-pressure; china_policy_watch)
        ("china_cgb_curve", "collectors.china_cgb_curve", "ChinaCgbCurveAdapter"),  # full CGB term structure (monetary-stance/risk-appetite; china_policy_watch)
