...
def test_render_smoke_bilingual():
    ...
    assert "Froth × Fragility" in html and "狂热 × 脆弱" in html       # title both langs (mx5: × separator)
    ...
    assert "hidden selling" in html and "暗中派发" in html            # face-B (distribution) read both langs
