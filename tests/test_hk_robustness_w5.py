...
class TestAlignmentEmptyBanner:
    ...
    def test_empty_alignment_produces_health_entry(self):
        ...
        # We test the logic by exercising the fragment in isolation via the real
        # _atier / _entry_ok helpers — simulated here rather than calling the full
        # compute_hk_standouts (which has deep I/O dependencies).
        #
        # Strategy: call the two list-comprehension lines directly and assert the
        # _pre_health list gets the banner appended.
        ...
        elig = [e for e in entries if _entry_ok(e) and _atier(e)]
