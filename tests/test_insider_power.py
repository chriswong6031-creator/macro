"""tests/test_insider_power.py — Tests for engine.insider_power.
...
import engine.insider_power as ip
from engine.insider_power import (
    SIGNALS,
    N_TRADES,
    LOOKBACK_DAYS,
    HALF_LIFE_DAYS,
...
def test_import():
    ...
    import engine.insider_power  # noqa: F401
