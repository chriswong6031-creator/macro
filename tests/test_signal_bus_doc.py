...
def test_all_artifact_ids_present():
    ...
    assert len(artifact_ids) == 558, (
        f"Expected 558 artifacts in synapse.yml, found {len(artifact_ids)}. "
        "Update the test if the registry count changed intentionally."
        " (Capital Structure Wave 2C added the retrieval-queue fairness receipt = 557->558;"
