...
def test_all_artifact_ids_present():
    ...
    assert len(artifact_ids) == 554, (
        f"Expected 554 artifacts in synapse.yml, found {len(artifact_ids)}. "
        "Update the test if the registry count changed intentionally."
        " (Capital Structure Wave 2B added capital-structure-document-term-observations = 553->554;"
