...
def test_all_artifact_ids_present():
    ...
    assert len(artifact_ids) == 487, (
        f"Expected 487 artifacts in synapse.yml, found {len(artifact_ids)}. "
        "Update the test if the registry count changed intentionally."
        "(darkpool darkpool_context.v1 lobe #3314 added darkpool-context-latest = 486->487;"
