...
def test_all_artifact_ids_present():
    ...
    assert len(artifact_ids) == 410, (
        f"Expected 410 artifacts in synapse.yml, found {len(artifact_ids)}. "
        "Update the test if the registry count changed intentionally."
        " (LHB-W2c symbol-directory archival added long-hold-symbol-directory = 409->410;"
