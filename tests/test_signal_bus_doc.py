...
def test_all_artifact_ids_present():
    ...
    assert len(artifact_ids) == 524, (
        f"Expected 524 artifacts in synapse.yml, found {len(artifact_ids)}. "
        "Update the test if the registry count changed intentionally."
        " (Filing Forensics v1 added fundamental-forensics-private-state = 523->524;"
