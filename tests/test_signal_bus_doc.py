...
def test_all_artifact_ids_present():
    ...
    assert len(artifact_ids) == 474, (
        f"Expected 474 artifacts in synapse.yml, found {len(artifact_ids)}. "
        "Update the test if the registry count changed intentionally."
        "(Prophet W2 added prophet-status, prophet-suggestions, prophet-pick-autopsies = 471->474;"
