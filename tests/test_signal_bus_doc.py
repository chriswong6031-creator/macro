...
def test_all_artifact_ids_present():
    ...
    assert len(artifact_ids) == 493, (
        f"Expected 493 artifacts in synapse.yml, found {len(artifact_ids)}. "
        "Update the test if the registry count changed intentionally."
        "(PSS-W2 added personality-timing-codex = 492->493 — #3460 merged the registry entry without regenerating docs/SIGNAL_BUS.md or bumping this pin, leaving neural-web RED on main;"
