...
def test_all_artifact_ids_present():
    ...
    assert len(artifact_ids) == 287, (
        f"Expected 287 artifacts in synapse.yml, found {len(artifact_ids)}. "
        "Update the test if the registry count changed intentionally."
        " (policy-shock W1-C added flip-confirmation-events, flip-confirmation-snapshot = 285->287;"
