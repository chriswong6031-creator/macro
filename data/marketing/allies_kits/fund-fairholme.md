# Allies Kit — Fairholme Capital (Berkowitz)

## 1. Who + Why Aligned

- **Target:** Fairholme Capital (Berkowitz)
- **Kind:** fund_manager
- **Style / description:** superinvestor_value
- **Topical overlap:** 80% — universe match (US stocks / technicals / options / macro)
- **Score:** 0.860 (display-tier ranking input only)
