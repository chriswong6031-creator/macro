# Allies Kit — Kimmeridge Energy Management

## 1. Who + Why Aligned

- **Target:** Kimmeridge Energy Management
- **Kind:** fund_manager
- **Style / description:** sector_other
- **Topical overlap:** 60% — universe match (US stocks / technicals / options / macro)
- **Score:** 0.770 (display-tier ranking input only)
