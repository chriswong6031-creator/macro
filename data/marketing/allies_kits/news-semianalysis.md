# Allies Kit — SemiAnalysis — semiconductor & AI infrastructure deep dives

## 1. Who + Why Aligned

- **Target:** SemiAnalysis — semiconductor & AI infrastructure deep dives
- **Kind:** newsletter
- **Style / description:** newsletter
- **Topical overlap:** 75% — universe match (US stocks / technicals / options / macro)
- **Score:** 0.838 (display-tier ranking input only)
