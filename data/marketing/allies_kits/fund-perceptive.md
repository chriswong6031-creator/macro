# Allies Kit — Perceptive Advisors

## 1. Who + Why Aligned

- **Target:** Perceptive Advisors
- **Kind:** fund_manager
- **Style / description:** sector_healthcare
- **Topical overlap:** 55% — universe match (US stocks / technicals / options / macro)
- **Score:** 0.748 (display-tier ranking input only)
