# Allies Kit — Duquesne Family Office (Druckenmiller)

## 1. Who + Why Aligned

- **Target:** Duquesne Family Office (Druckenmiller)
- **Kind:** fund_manager
- **Style / description:** macro_satellite
- **Topical overlap:** 85% — universe match (US stocks / technicals / options / macro)
- **Score:** 0.883 (display-tier ranking input only)
