...
next_action: >
  ...
  Sol on that receipt. The live front of this workstream is the separate method-hardening TFG arc.
  ...
  STOPPED_AT_DEVELOPMENT_GATE with an accepted FIRST gold falsifier: three omitted combined
  Q&A-opener-plus-first-question separators, ratified as
  DEC:E3FMT-DEVELOPMENT-GOLD-R2-FIRST-HANDOFF-OMISSIONS.
  ...
  order-dependent first-failure reason. QNA_SOURCE_CLEAN now requires positive replayable
  same-revision respondent role/title support; absence of conflict alone is NOT clean. Machine
  grading truth is
  research/earnings_intelligence/e3/tfg1_development_boundary_identity_adjudication_r3.json; the
  historical TFG-0 110-boundary receipt and the R2 adjudication/decision are preserved byte-unchanged
  as falsified evidence.
  TFG-1 R3 is NOT_BUILT. Next action: once this records-only correction
  (tfg1-r3-gold-source-clean-correction-20260828-v1) is Sol-accepted and landed, commission exactly
  one bounded frontier coding worker on
  ...
  R2 operation keys are spent and must not be reused. The eight holdout revisions remain SEALED
  (holdout_bodies_inspected: 0) until R3's corrected development gates are green and an exact
...
do_not_redo:
  ...
  - Do not reuse operation key tfg1-deterministic-transcript-format-hardening-20260827-v1 or tfg1-r2-deterministic-transcript-format-hardening-20260827-v1. BOTH terminate at accepted development-gold falsifiers (v1 structural, R2 respondent-role); the successor implementation is the distinct key tfg1-r3-deterministic-transcript-format-hardening-20260828-v1.
  ...
  - Do not open the eight TFG holdout revisions (ranks 17-24) until R3's corrected development gates are green and an exact implementation head is frozen. The holdout is single-use and explicitly non-replaceable; spending it against an unratified gold destroys the only unseen format evidence TFG owns.
  ...
  - Do not mutate, reopen, merge, reset, force-push or wholesale cherry-pick PR #6591 or branch claude/tfg1-r2-transcript-format-hardening. It is CLOSED UNMERGED and preserved as evidence at head 77fd9411c9cfb799b245c8138d2f1a40052d3b8d; its commits are reusable candidate changes only, not accepted implementation truth.
...
waves:
  ...
  - id: E3-FMT-TFG-1-R2
    ...
    next_action: >
      ...
      tfg1-r3-gold-source-clean-correction-20260828-v1 as
      DEC:E3FMT-DEVELOPMENT-GOLD-R3-RESPONDENT-ROLE-SOURCE-CLEAN.
  - id: E3-FMT-TFG-1-R3
