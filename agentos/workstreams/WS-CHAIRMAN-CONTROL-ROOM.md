...
waves:
  ...
  - id: P0
    ...
    depends_on: [F0]
    next_action: >
      Start exactly one fresh dedicated Fable principal-builder session from the
      accepted Mastermind architecture; do not split top-level ownership across
...
next_action: >
  Start one fresh dedicated Fable principal-builder session using the merged
  FABLE-00 commission in Mastermind PR #108. Fable owns the complete P0 until one
  held implementation return comes back to Sol for adversarial review.
---
...
P0 is complete only after the real M3 Ultra environment demonstrates at least three
current organizational work items, canonical source/degradation truth, and real
one-click reopening of representative Sol, Fable, worker and GitHub evidence
surfaces. Green CI or a fixture-only dashboard is insufficient.
