...
artifacts:
  ...
  - research/prophet_v4/D5_EARNINGS_ENTRANCE_HOLD_2026-08-30.md
  - agentos/handoffs/PROPHET-US-V4-RECOVERY-2026-08-30-d5-entrance-hold.md
waves:
  - id: 0a
  ...
  - id: d5
    ...
    wait:
      ...
      condition: >
        Recheck only after a new natural B1 generation or an accepted owner-native
        issuer-CIK reader lands; neither event authorizes D5 implementation alone.
  - id: d6
    depends_on: [d5]
