...
waves:
  ...
  - id: k1
    ...
    status: in_progress
    depends_on: [c0]
    next_action: Sol reviews the authenticated-rider-complete v1.0.0 contract-only packet and returns ACCEPT or exact K1 amendments. No dependent wave starts before Sol's ruling.
  - id: k2
  ...
  - id: k7
    ...
    depends_on: [k6]
next_action: >
  Sol reviews the authenticated-rider-complete K1 Evidence Foundation v1.0.0
  return packet at
  research/evidence_mesh/K1_EVIDENCE_FOUNDATION_CONTRACT_FREEZE_2026-08-23.md.
  Sol rules ACCEPT or names exact amendments. The named four-owner AAPL fixture
  ...
  K3, K4, B1A, K2-B, D5-EARNINGS, or any dependent wave before Sol accepts K1.
---
