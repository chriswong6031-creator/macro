...
next_actions:
  ...
  - "GATE: Sol's POST-MERGE final freeze acceptance of canonical main — no builder spawn before it. On GO: amend DEC + WS to mark the freeze effective, then spawn PR-0B + RIGHTS-0 in parallel, PR-0D in parallel with WS:STOCK-IDENTITY coordination; P1 behind the RIGHTS-0 visit-source verdict."
