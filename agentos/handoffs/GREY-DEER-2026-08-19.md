...
verified:
  ...
  - claim: 000660.KS issuer tape is not in this checkout.
    ...
    result: missing.
  - claim: US Prophet tech share of buyable was ~12% on both 2026-08-17 and 2026-08-18.
    command: python3 on data/us_prophet_rank/candidates/2026-08.parquet
    result: 29/241 then 6/52.
unverified:
...
- Dual-read **transport** only: LC state beside Market State / Risk Radar, with authority labels. No new score.
- `auction_concession_proxy_v1` × already-BROKEN LC × next-session long-yield confirmation — **only after** a design-era test. Not from this incident.
