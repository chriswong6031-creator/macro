...
REGISTRY: list[dict] = [
    ...
    # ---- PENDING (validated, lives off-branch) ------------------------------
    _row("SUE — standardized unexpected earnings (earnings momentum)",
         "SUE — 标准化超预期盈利（盈利动量）", "US S&P1500", "pending",
         why="Built from a new EDGAR quarterly-EPS pipeline and PASSED Phase-0 (survives FDR), "
             "scored as a standalone leg on factors.html — but that work is merged to origin/qfe "
             "via PR #35, not present on this branch. The one clean free earnings-momentum win.",
         why_zh="基于新的 EDGAR 季度 EPS 管线构建并通过 Phase-0（通过 FDR），作为 factors.html 的独立腿计分 — 但该工作经 PR #35 合并至 origin/qfe，本分支尚无。是唯一干净的免费盈利动量胜出。",
         source="data-signal-expansion-2026 / PR #35", horizon="63d", fdr_survivor=True,
         wired="origin/qfe only (promote to wire here)"),
]
