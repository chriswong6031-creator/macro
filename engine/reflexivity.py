...
Earnings-week leg: OMITTED in v1. Honest null field emitted. (R-D ruling)
    ...
    for i, tkr in enumerate(ordered):
        ...
        for peer, sim in sims_row[:3]:
            ...
            nearest.append({
                ...
                "same_earnings_week": None,  # R-D: not wired in v1
            })
        ...
        by_ticker[tkr] = {
            ...
            "nearest": nearest,
            "earnings_leg": None,            # R-D: not wired in v1
            "earnings_leg_note": "earnings-cluster not wired in v1",
