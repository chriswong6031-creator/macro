...
SCOPE:
- #f-terminal (index.html ~292-440 + its CSS ~371-497): §6.2 environment (arcs texture, frame stroke rgba(255,255,255,.09), --r-xl, --sh-stage, blue under-glow), two-tone headline (white+#9aa6b8 slate), logo row normalization, .mk rail labels via existing classes. JS chart draw untouched.
