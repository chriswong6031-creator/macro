...
|---|--:|--:|--:|--:|--:|--:|--:|--:|
| value | 0.0446 | 0.344 | 0.688 | 1.14 | 0.2544 | 0.6061 | 0.636 | 11 |
| payout | 0.0089 | 0.189 | 0.378 | 0.644 | 0.5193 | 0.8508 | 0.636 | 11 |
...
| low_beta | -0.0313 | -0.142 | -0.284 | -0.611 | 0.5414 | 0.8508 | 0.455 | 11 |
| composite_orth | -0.014 | -0.205 | -0.41 | -1.091 | 0.2755 | 0.6061 | 0.455 | 11 |
| profitability | -0.0442 | -0.432 | -0.864 | -1.486 | 0.1374 | 0.5038 | 0.455 | 11 |
| accruals | -0.0296 | -0.694 | -1.387 | -2.456 | 0.014 | 0.077 | 0.182 | 11 |
| quality | -0.0432 | -0.721 | -1.443 | -2.905 | 0.0037 | 0.0407 | 0.182 | 11 |

**Survive BH-FDR(10%):** quality, accruals

## Factor overlap (latest cross-section)

`composite_orth` above is the Löwdin-decorrelated composite. Mean |factor corr| **0.13** raw → **0.062** orthogonalized (the redundancy removed). VIF>5 = redundant. Most-correlated pairs:
