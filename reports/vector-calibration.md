...
Span: 2015-01-01..2026-07-25 (4224 days). Split-half boundary: 2021-01-01.
...
| dvol | **EXTREMES — low <40: +8.4%/90d 46.8% hit (n=247) [weak]; high >90: +15.8%/90d 71.4% hit (n=168) [weak]** | 0 | 0 | 0 | -1 |
...
| reserve_risk | **EXTREMES — low <.0015: +17.2%/90d 65.4% hit (n=979) [weak]; high >.02: -42.5%/90d 4.2% hit (n=48) [TOP]** | 1 | 0 | -1 | -1 |
| impulse | **DIRECTIONAL (one half weak)** | 1 | 0 | 1 | 1 |
| cycle_pct | **DIRECTIONAL (one half weak)** | -1 | -1 | 0 | -1 |
| cot_z | **EXTREMES — low <-1.5: +13.2%/90d 47.8% hit (n=224) [weak]; high >1.5: -6.2%/90d 32.6% hit (n=635) [TOP]** | -1 | 0 | -1 | -1 |
| corr_spx | **CONFIRMED** | -1 | -1 | -1 | -1 |
| vdd_multiple | **EXTREMES — low <.5: +6.8%/90d 41.0% hit (n=779) [weak]; high >2.9: +35.2%/90d 59.1% hit (n=154) [weak]** | 1 | 1 | 0 | -1 |
| global_m2_yoy | **DIRECTIONAL (full only)** | 1 | 0 | -1 | 1 |
| rv_cone_pctile | **EXTREMES — low 0-25: +24.8%/90d 70.6% hit (n=1227) [weak]; high 75-100: +30.1%/90d 63.8% hit (n=831) [weak]** | 0 | 0 | 0 | -1 |
...
|:-------|-----:|-----------:|-----------:|------------:|------------:|------------:|------------:|
| 0-25   | 2063 |      -2.99 |     -14.21 |       -8.28 |      -26.07 |      -13.98 |      -46.92 |
| 25-50  | 1349 |      -4.03 |     -16.22 |       -9.85 |      -30.25 |      -17.63 |      -50.33 |
...
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| 0-25   | 2063 |     56.2 |      1.97 |      56.2 |       7.77 |      66.5 |      28.73 |
| 25-50  | 1349 |     53.3 |      0.68 |      57.8 |       5.17 |      51.1 |      16.43 |
| 50-75  |  708 |     54   |      0.71 |      59.1 |       4.49 |      56.3 |      14.35 |
...
| band    |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-0.5   | 1054 |     53.3 |      0.22 |      56.9 |       1.96 |      51.3 |       6.58 |
| -0.5..0 |  685 |     51.6 |      0.69 |      56.6 |       3.92 |      57.5 |      18.94 |
| 0..0.5  |  787 |     51.6 |      0.68 |      53.6 |       5.56 |      53.8 |      22.51 |
...
| band         |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| broken       | 1170 |     53.1 |      0.46 |      59.9 |       3.23 |      57.3 |      12.2  |
| neutral      | 1248 |     53.7 |      0.93 |      55.6 |       6.16 |      56.1 |      22.11 |
| constructive | 1806 |     56.5 |      2.19 |      56.6 |       8.34 |      63.8 |      28.31 |

### risk_oscillator — forward returns by band (full sample)

| band    |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| falling | 1688 |     55.9 |      1.94 |      58.7 |       6.2  |      58.4 |      21.97 |
| neutral | 1256 |     54.9 |      1.32 |      58.3 |       7.06 |      62.9 |      24.41 |
| rising  | 1280 |     53   |      0.58 |      54.1 |       5.67 |      58.5 |      19.94 |

### bfi — forward returns by band (full sample)

| band   |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <40    | 1609 |     51.2 |      0.51 |      52.6 |       3.49 |      49   |      13.07 |
...
| 0-1    | 1237 |     53.9 |      0.96 |      56.3 |       3.79 |      49.2 |       4.62 |
...
| 0-.25  |  659 |     58.1 |      1.82 |      67.4 |       6.93 |      56   |       9.88 |
| .25-.5 | 1670 |     52.9 |      0.73 |      52.9 |       2.59 |      60   |      16.72 |
...
| band    |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <0.8    |  633 |     54.7 |      1.01 |      61.9 |       4.08 |      48.1 |      11.26 |
| 0.8-1   |  982 |     51.6 |     -0.02 |      52.9 |       1.89 |      52.1 |      10.93 |
...
| 0.5-1  | 1723 |     54.2 |      0.64 |      58.7 |       4.13 |      61.2 |      20.49 |
...
| band   |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-10%  | 321 |     53.9 |      0.6  |      59.6 |       1.78 |      32.5 |      -1.27 |
| -10-0% | 366 |     52.4 |      0.02 |      56.3 |       2.25 |      70   |      23.46 |
| 0-20%  | 621 |     53.1 |      1.17 |      52.5 |       4.5  |      58.6 |       9.2  |
...
| capitulation |  779 |     53.4 |      0.32 |      52.3 |       2.22 |      58.8 |      16.16 |

### dvol — forward returns by band (full sample)

| band   |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <40    | 247 |     49.6 |     -0.6  |      40.6 |      -1.07 |      46.8 |       8.4  |
| 40-55  | 655 |     52.1 |      0.96 |      59.3 |       4.4  |      60.9 |      11.32 |
...
| 0-5    | 377 |     50.8 |      0.22 |      53.6 |       2.36 |      34.9 |       1.32 |
| 5-15   | 716 |     46.8 |     -0.46 |      46.1 |      -0.57 |      51.2 |       3.74 |
...
| 25-50  | 443 |     52.3 |      0.2  |      53.6 |       2.57 |      60.5 |      13.69 |
| 50-75  | 340 |     51.8 |      0.38 |      49.2 |       2.52 |      44.7 |       3.1  |
...
| -10-0% | 531 |     53.4 |      1.24 |      59.3 |       4.79 |      63   |      13.35 |
| 0-10%  | 643 |     52.7 |      0.61 |      52.1 |       3.35 |      53   |       9.39 |
| 10-25% | 151 |     49   |     -0.23 |      52.3 |       0.73 |      45.6 |       6.46 |
...
| -2-0%  |  857 |     53.9 |      1.52 |      56.3 |       7.47 |      61.5 |      17.97 |
| 0-2%   |  861 |     52.7 |      1.14 |      56.5 |       5.32 |      61.1 |      21.88 |
| 2-5%   |  724 |     59.8 |      2.1  |      60   |       8.85 |      69.1 |      37.21 |
...
| -.1-.1 | 968 |     58.1 |      1.91 |      58.8 |       8.04 |      56.1 |      19.46 |
| .1-.3  | 946 |     54.5 |      1.66 |      58.7 |       7.55 |      61.7 |      17.9  |
...
| -.3-0  |  987 |     51.3 |      0.2  |      51.2 |       1.84 |      44.2 |       5.42 |
| 0-.5   | 1882 |     52.6 |      0.98 |      52.8 |       4.18 |      55.6 |      13.44 |
...
| .5-1.5 | 1414 |     52.3 |      0.64 |      51.2 |       3.5  |      53.7 |      22.06 |
...
| band    |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <0.7    | 365 |     50.8 |      0.14 |      54   |       0.51 |      49.8 |       5.68 |
...
| band      |   n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:----------|----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-.75     | 214 |     47.2 |     -0.37 |      38.3 |      -3.53 |      41.8 |       0.85 |
| -.75--.25 | 143 |     51   |      0.02 |      53.6 |       0.1  |      42.1 |       0.35 |
| -.25-.25  | 159 |     47.8 |      0.17 |      56.7 |       2.23 |      43.3 |       3.03 |
| .25-.75   | 110 |     63.6 |      1.5  |      62.4 |       4.91 |      58.2 |       9.36 |
| >.75      | 164 |     57   |      1.12 |      57.3 |       4.02 |      60.3 |       6.72 |

### reserve_risk — forward returns by band (full sample)

| band        |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:------------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <.0015      |  979 |     55.8 |      1.47 |      61.8 |       5.67 |      65.4 |      17.24 |
...
| -.15-.15 | 2048 |     52.4 |      0.59 |      54.9 |       4.52 |      57.5 |      18.08 |
| .15-.5   |  580 |     59   |      2.23 |      63.7 |       9    |      61.7 |      27.43 |
...
| markdown | 1287 |     49   |     -0.5  |      48.1 |      -0.93 |      41.2 |       4.5  |
...
| >1.5     | 635 |     45.9 |     -0.98 |      44.6 |      -3.34 |      32.6 |      -6.23 |
...
| .2-.4  | 1039 |     53.9 |      0.66 |      49.4 |       2    |      56.2 |      10.94 |
| >.4    |  943 |     50.8 |      0.53 |      56.5 |       2.67 |      49.1 |      12    |

### vdd_multiple — forward returns by band (full sample)

| band    |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:--------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <.5     |  779 |     55.2 |      0.5  |      53.8 |       2.75 |      41   |       6.82 |
...
| 7-8.5  |  784 |     54.6 |      1.98 |      55.2 |      10.28 |      59.5 |      39.11 |
...
| band   |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| 0-25   | 1227 |     55.2 |      1.2  |      59   |       5.52 |      70.6 |      24.84 |
| 25-50  | 1073 |     52.9 |      0.72 |      49.9 |       2.29 |      50.1 |      15.61 |
...
| 25-50  | 1013 |     53.2 |      0.9  |      56   |       6.42 |      55.5 |      20.04 |
| 50-75  |  993 |     54.5 |      1.56 |      60.1 |       6.56 |      62.3 |      27.61 |
...
| band   |    n |   hit_7d |   mean_7d |   hit_30d |   mean_30d |   hit_90d |   mean_90d |
|:-------|-----:|---------:|----------:|----------:|-----------:|----------:|-----------:|
| <-1    |  415 |     44.9 |     -1.05 |      40.8 |      -2.83 |      41.8 |       0.7  |
| -1-0   | 1557 |     53.3 |      0.95 |      53.9 |       4.23 |      54   |      16.51 |
...
|:-------------|-------:|-------------:|---------------:|------------:|---------:|--------------:|----------:|---------------:|--------:|-------------:|-----------------:|------------------:|----------------:|
| conservative |   55.2 |         57.4 |            2.2 |        58.4 |     1.5  |          1.02 |      1.51 |           1.37 |   -27   |        -83.8 |             53.1 |              14.4 |            0.79 |
| moderate     |   71.3 |         73.6 |            2.3 |        58.4 |     1.59 |          1.02 |      1.81 |           1.37 |   -32.3 |        -83.8 |             68.5 |              13.1 |            2.48 |
| aggressive   |   74.8 |         77   |            2.2 |        58.4 |     1.53 |          1.02 |      1.75 |           1.37 |   -36.4 |        -83.8 |             71.8 |              12.4 |            3.13 |
| optimal      |   70.8 |         73   |            2.2 |        58.4 |     1.59 |          1.02 |      1.81 |           1.37 |   -32.3 |        -83.8 |             69.3 |              13.1 |            2.39 |
...
|              |   cagr |   cagr_gross |   cost_drag_pp |   hodl_cagr |   sharpe |   hodl_sharpe |   sortino |   hodl_sortino |   maxdd |   hodl_maxdd |   time_in_market |   turnover_annual |   final_vs_hodl |
|:-------------|-------:|-------------:|---------------:|------------:|---------:|--------------:|----------:|---------------:|--------:|-------------:|-----------------:|------------------:|----------------:|
| conservative |   50.8 |         53.3 |            2.5 |        58.4 |     1.38 |          1.02 |      1.51 |           1.37 |   -33.6 |        -83.8 |             62.9 |              16.7 |            0.57 |
| moderate     |   63.5 |         66.1 |            2.7 |        58.4 |     1.45 |          1.02 |      1.78 |           1.37 |   -37.1 |        -83.8 |             80.6 |              16.2 |            1.44 |
| aggressive   |   62.6 |         65.2 |            2.6 |        58.4 |     1.33 |          1.02 |      1.65 |           1.37 |   -45.2 |        -83.8 |             85.4 |              15.7 |            1.36 |
| optimal      |   62.1 |         64.7 |            2.6 |        58.4 |     1.42 |          1.02 |      1.75 |           1.37 |   -41.2 |        -83.8 |             81.8 |              16.2 |            1.3  |

**Block-bootstrap 95% CI** [optimal, 5000 resamples, 21d blocks]: Sharpe **1.59** [0.98, 2.19] · MaxDD -41.3% [-29.7, -60.2] · P(Sharpe>0) 1.0. Circular block bootstrap (21d blocks) of the NET daily strategy returns → 95% CI [2.5, 50, 97.5]. sharpe_gt0_prob = bootstrap P(Sharpe>0). Pairs with the Deflated-Sharpe haircut: DSR deflates the mean, this bounds the variance.
...
OOF 7d direction: **Brier 0.2491** vs base 0.2478 (skill -0.005); Platt a=0.756, b=0.041. Out-of-fold: each day's P(up) is the momentum×risk cell rate fit on the OTHER folds (EB-shrunk, the live mechanism), scored vs realized. brier<base_brier = skill; Platt a≈1/b≈0 = already calibrated. Direction is a near-coin-flip, so calibrated probabilities cluster near the base rate — that is the honest result.

| prob bin | n | predicted | observed |
|---|--:|--:|--:|
| 0.5-0.6 | 3709 | 0.546 | 0.548 |
| 0.6-0.7 | 65 | 0.604 | 0.462 |
...
- DSR (gated) — P(true Sharpe > 0): **0.9892**
- Observed Sharpe 1.59 ann (0.082966/day); haircut threshold SR0 0.81 ann
- N=71 trials (upper-bound, incl. override dof_cost) · T=4224d · skew=0.673 · kurt=14.47 · SR-variance: max(cross-variant dispersion, null SR-sampling proxy)
- **Effective-N haircut**: T_eff=2494.7 vs raw T=4224 (rho_sum_K20=0.3466); dsr_effN=0.9644 (dsr_legacy=0.9989). Block-bootstrap refinement: W5.
...
- DSR (raw) — P(true Sharpe > 0): **0.9661**
- Observed Sharpe 1.42 ann; SR0 0.81 ann
- N=71 trials · T=4224d · skew=0.605 · kurt=13.167
- **Effective-N haircut**: T_eff=2511.2, dsr_effN=0.9146 (dsr_legacy=0.9936)
...
As-of 2026-07-25: **n_trials_declared=71** = n_trials_config=65 (config upper-bound) + override dof_cost (registry).
...
Ensemble OOF rank-IC vs 90d return: **0.196** (best single axis = `net_liq_roc`). Per-axis IC: risk_index 0.085, net_liq_roc 0.266, vrp nan, cot_z 0.012, mvrv_z 0.064, momentum 0.141.

## Whipsaw

|                  |   changes |   whipsaws |   pct |
|:-----------------|----------:|-----------:|------:|
| momentum_state   |       181 |         37 |  20.4 |
| risk_regime      |       114 |         21 |  18.4 |
| structure_state  |       179 |         36 |  20.1 |
