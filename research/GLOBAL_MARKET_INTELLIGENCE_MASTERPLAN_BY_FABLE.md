...
6. **Regional-twin sequencing** — GMI W1b supplies the CN membership spine GR's regional twins need; GR4's declared gate ("after US proves") is untouched. Does Group Reads want to co-charter the CN-twin wave when its gate opens, or inherit the spine as-is?
