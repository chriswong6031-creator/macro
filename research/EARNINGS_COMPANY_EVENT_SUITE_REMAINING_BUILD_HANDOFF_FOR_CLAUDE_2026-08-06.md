...
- The real-time SEC 8-K Item 2.02 discovery/extraction lane exists through Macro [#4527](https://github.com/chriswong6031-creator/macro/pull/4527). Item 2.02 acceptance timestamps also re-enabled the governed M4 earnings event prior through [#4624](https://github.com/chriswong6031-creator/macro/pull/4624).
- Earnings collector breadth, staleness alarms, and catalyst fields are present through [#4341](https://github.com/chriswong6031-creator/macro/pull/4341) and [#4485](https://github.com/chriswong6031-creator/macro/pull/4485).

### 3.2 Evidence, stories, and product projections

- An append-only, content-addressed, receipt-verified transcript evidence catalog is shipped through [#4262](https://github.com/chriswong6031-creator/macro/pull/4262) and secured through [#4409](https://github.com/chriswong6031-creator/macro/pull/4409).
- Exact UTF-8 quote and numeric spans, source-body hashes, immutable generations, source correction lineage, deterministic digests, promotion decisions, canonical story shells, and story packets exist. See `engine/earnings_narrative/` and PRs [#4280](https://github.com/chriswong6031-creator/macro/pull/4280), [#4284](https://github.com/chriswong6031-creator/macro/pull/4284), and [#4287](https://github.com/chriswong6031-creator/macro/pull/4287).
...
- Company Intelligence immutable objects, public teaser, ticker-dossier integration, API, and verified Neural Web reader exist through [#4215](https://github.com/chriswong6031-creator/macro/pull/4215), [#4221](https://github.com/chriswong6031-creator/macro/pull/4221), [#4298](https://github.com/chriswong6031-creator/macro/pull/4298), [#4318](https://github.com/chriswong6031-creator/macro/pull/4318), and [#4327](https://github.com/chriswong6031-creator/macro/pull/4327).
- Hosted publication, exact private-generation reuse, public navigation, and launch hardening are shipped through [#4412](https://github.com/chriswong6031-creator/macro/pull/4412), [#4415](https://github.com/chriswong6031-creator/macro/pull/4415), and [#4417](https://github.com/chriswong6031-creator/macro/pull/4417).
