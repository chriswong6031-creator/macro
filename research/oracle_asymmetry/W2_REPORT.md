# OTA W2 — Member Transmission Report

> **MODERN-TRACK ONLY — DESCRIPTIVE/EXPLORATORY.**
> The word 'validated' does not appear in this document (Oracle Constitution §II).
> Era law: P0_MEASUREMENT_MEMO.md v1.1 (2026-07-05).
> Spec: research/oracle_asymmetry/W2_SPEC.md (pre-registered 2026-07-05, frozen).
> Gates: 2 registered reads. BH q=0.10 within this family.
> Seed: 20260705. Bootstrap draws: 2,000. Placebo draws: 500.
...
|--------|-------|-------|-------|-----------|--------|
| WR21 | 0.6522 | 0.5906 | 0.7087 | 31 | 31268 |
| Mean fwd_ret_21 | 0.0385 | 0.0244 | 0.0532 | 31 | 31268 |

## Regime-Matched Placebo (500 draws)

Placebo runtime: 3.0s | Draws producing valid delta: 500/500

| Metric | Observed Δ | Placebo p95 | p-value (placebo) | BH-corrected (q=0.10) |
|--------|-----------|-------------|-------------------|----------------------|
| ΔWR21 | 0.1163 | 0.0565 | 0.002 | True |
| Δ mean fwd_ret_21 | 0.0299 | 0.0090 | 0.000 | True |

## Gate Verdicts

**Pre-bound vocabulary:** CONDITION-LIFT / UNDERPOWERED-ACCRUING / NULL

- **G-W2-A** (ΔWR21 > 0 AND > placebo p95): PASS
  - IN WR21=0.6522  OUT WR21=0.5359  Δ=0.1163
  - Placebo p95=0.0565  p-value=0.002  BH-rejected=True
  - IN n_windows=31  IN n_rows=31268  OUT n_rows=369475

- **G-W2-B** (Δ mean fwd_ret_21 > 0 AND > placebo p95): PASS
  - IN mean fwd_ret_21=0.0385  OUT mean fwd_ret_21=0.0086  Δ=0.0299
  - Placebo p95=0.0090  p-value=0.000  BH-rejected=True

### VERDICT: **CONDITION-LIFT**

> Both G-W2-A and G-W2-B pass: delta positive and above placebo p95; BH-corrected at q=0.10. DESCRIPTIVE class — display-only until formal P3-style registration.
...
A second, independent Opus re-audit of this post-fix positive returned **SURVIVES-WITH-CAVEATS**: all headline numbers reproduced exactly from the committed artifacts (including the placebo p95s via the shipped code); the four fix-round corrections verified real in code; robustness probes — drop the single most favorable window (ΔWR21 0.1163→0.1040) and drop the most favorable quarter (→0.0823) — both remain above the placebo p95 (0.0565); 6 of 9 nodes positive (growth/cyclical-tilted; XLP/XLU genuinely negative in 2023 defensive selloffs, dragging the pooled delta DOWN).

**Binding verdict: CONDITION-LIFT — descriptive class, display-only until a formal P3-style registration.** Inference statement per spec §4: the headline deltas' sole inference is the 500-draw regime-matched placebo; cluster-bootstrap CIs attach to the IN-arm point estimates. Rulings and the ratified join-key amendment live in W2_SPEC.md §Amendment log.
