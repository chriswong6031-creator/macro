...
display rules) · crowded-calls chip (call_skew_rich — auto-activates as skew history
crosses 21 obs) · heaviest same-day share. Each row: 3–5 mono tickers deep-linking to
