...
3. **§8 leg 1 — R4 VIX-gradient prereg**: **DONE 2026-08-10 (session 2)** —
   ...
   immutable t0 VIXCLS 252d-percentile cells frozen, R4-A/R4-B claims + consequence
   matrix). Remaining: check maturity counts without reading outcomes; stressed rows
   accrue only on forward event dates stamped at percentile ≥ 0.8.
