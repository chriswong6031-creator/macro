...
- The Wave 7 checkpoint passes 259 focused Government Revenue/build/API/UI/Prophet/Neural Web tests plus template/site asset, JavaScript syntax, projection, and raw edge-budget guards.
