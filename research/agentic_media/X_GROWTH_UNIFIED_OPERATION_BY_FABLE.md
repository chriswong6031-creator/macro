...
- The ≥80% blind-identity target is a point estimate with no n or CI, judged on samples from the generator it polices — pre-register the eval (sample size, holdout construction, chance = 20% baseline) in XG-W6 before the number gates anything.
