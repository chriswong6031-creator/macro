...
Generated: 2026-08-18T08:33:11Z  |  25 workstreams (20 active · 1 awaiting_ci · 1 awaiting_review · 3 blocked)

| Input | Value |
|---|---|
| active_builds | data/governance/active_builds.json@2026-08-18T08:33:11.395658+00:00 |
| active_builds age | 0.0h |
| worktrees | 1 |
| records | 25 WS · 61 DEC · 47 DSC · 55 handoffs |
...
|---|---|---|---|---|---|---|
| [`WS:ADVANCED-DATA-OPTIONS`](../agentos/workstreams/WS-ADVANCED-DATA-OPTIONS.md) | awaiting_review | coo-fable | options-intelligence | awaiting_ci:1 done:1 todo:1 | #5830(merged) #5838(merged) #5849(merged) #5860(merged) | Sol review of the AD-1P0 semantic-authority freeze; on PASS, commission AD-1 implementation per the amended handoff (v1.2). |
...
| [`WS:CI-MERGE-CONTROL-PLANE`](../agentos/workstreams/WS-CI-MERGE-CONTROL-PLANE.md) | active | coo-fable | project-active-build-control | awaiting_ci:1 done:1 in_progress:1 | — | STOP the W-SEMANTIC-PROOF wave. Keep W-REWRITE and CI-speed/scoping as separately commissioned work; do not begin either from this completion. |
...
| [`WS:DEFENSE-PROCUREMENT-V3`](../agentos/workstreams/WS-DEFENSE-PROCUREMENT-V3.md) | active | coo-fable | government-revenue-foresight | done:1 in_progress:1 todo:4 | #5814(merged) #5819(merged) | Merge and live-prove the D1 entitled-desk rescue. Stop after that proof. Do not start Atlas/D2. Do not merge #5424. |
| [`WS:EARNINGS-INTELLIGENCE-OS`](../agentos/workstreams/WS-EARNINGS-INTELLIGENCE-OS.md) | active | coo-fable | earnings-intelligence | done:3 todo:1 | #5817(merged) #5841(merged) | Implement E2 exactly as frozen; render the now-live AAPL FY2026 Q3 event_workspace.v1 through read_event_workspace in the existing Terminal Company Intelligence workspace and Macro dossier glance. Do not re-read the v1 score overlay for the glance and do not broaden scope into E3+. |
...
| [`WS:FINANCIAL-INTELLIGENCE-FABRIC`](../agentos/workstreams/WS-FINANCIAL-INTELLIGENCE-FABRIC.md) | active | coo-fable | fundamental-forensics | done:1 in_progress:1 todo:10 | — | Sol reviews the FIF-1R2 packet-contract PR. Do not merge until that review accepts. Do not start FIF-2. Native auto-merge and merge-on-green stay disarmed. |
...
| [`WS:LIVE-ENTRY-RADAR`](../agentos/workstreams/WS-LIVE-ENTRY-RADAR.md) | active | coo-fable | market-timing-intelligence | done:6 in_progress:1 todo:3 | #5578(merged) #5625(merged) #5698(merged) #5724(merged) #5768(merged) #5825(merged) #5834(merged) | Sol reviews the W6 Research Priority PR against the frozen outcome/authority firewall. Do not mark W6 done at merge; live-payload commissioning follows. Do not start W7. W8 UI reference remains |
...
| [`WS:PROPHET-CONDITIONAL-FUSION`](../agentos/workstreams/WS-PROPHET-CONDITIONAL-FUSION.md) | active | fable | prophet-us | done:5 todo:5 | — | PR-3C (this wave) lands the durable W3 paired/family/coverage ledger and wires it into us_prophet_ledgers after grading. After it merges, a FRESH session starts PR-3D only: live instrumentation acceptance + lawful status/display (accrual/maturity/gap only before the 20 matured-H10-session floor). Do not read forward C1-vs-shadow outcomes. Do not implement PR-3D in the PR-3C session. w2 is done (#5700) but real C2 commissioning is still data-gated. w2b live-accepted. w3 stays todo until PR-3D. Durable paired-race N remains 0 until the first post-#5769 candidates-store commit matures at H=10. #5742 is external availability debt. Canonical five-leg nulls on v3 are correct (#5769). STILL OPEN from w1: the §13.0 live-accrual closure. |
...
| [`WS:PROPHET-US-V4-RECOVERY`](../agentos/workstreams/WS-PROPHET-US-V4-RECOVERY.md) | active | fable | prophet-us | done:2 todo:27 | #5832(merged) #5847(merged) | V4-0B complete. DO NOT SPAWN A1 — the Availability/outage sessions own the implementation (#5742); await their return for Sol acceptance against the frozen A1 contract. A2/A3 are adopt-first (map the sibling return before any spawn). The next independently authorized V4 session is D1 (theme-source + identity census), started FRESH — never inside 0B. D3 stays gated on the GMI merge-order ruling. |
...
- WS:ADVANCED-DATA-OPTIONS — record_disagrees_with_execution: wave AD-1P0 is 'awaiting_ci' but PR #5860 is merged
